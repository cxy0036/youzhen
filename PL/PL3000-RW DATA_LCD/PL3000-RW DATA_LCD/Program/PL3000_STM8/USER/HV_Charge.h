...
#define FLASH_STANDAR_OVER_THR         192  //0x00C0//0x0151   /* 0.90v ----> HV: 170V*/
...
#define FULL_CHARGE_LEVEL1             778
#define FULL_CHARGE_LEVEL2             790
#define FULL_CHARGE_LEVEL3             810//768  //0x0300 650
#define FULL_CHARGE_LEVEL4             830//792  //0x0318   /* 3.871v ----> HV: 737.8V*/
#define FULL_CHARGE_LEVEL5             845//816  //0x0330   /* 4.075v ----> HV: 754.6V*/ 
#define FULL_CHARGE_LEVEL6             860//840  //0x0348   /* 4.166v ----> HV: 771.5V*/ 
#define FULL_CHARGE_LEVEL7             875//864  //0x0360   /* 4.257v ----> HV: 788.3V*/ 
#define FULL_CHARGE_LEVEL8             890  //0x037A   /* 4.348v ----> HV: 805.2V*/  
